...
export default function InternCertificateForm({ currentIntern }: Props) {
  ...
  const onSubmit = useCallback(
    async (data: FormValuesProps) => {
      try {
        ...
        if (currentIntern?.certificate) {
          ...
          // gọi API update
          await axios.put(`${process.env.REACT_APP_HOST_API}/api/user/updateCertificate`, {
    ...
    [enqueueSnackbar, reset, currentIntern, uploadImageToCloud]
  );
