...
export default function InternPDFHomeIQAndPushUp({ invoice, startIndex = 0 }: Props) {
  // const { name } = invoice;
        ...
        <View style={styles.table1}>
          <View>
            <View style={[styles.tableRow, {borderTopWidth: 1}]}>
              ...
              <View style={[styles.tableCell_9, styles.titleBackground]}>
                <Text style={styles.subtitle2}>１分間の</Text>
                <Text>腕立て伏せ</Text>
                <Text>テスト</Text>
              </View>
              {/* <View style={[styles.tableCell_9, styles.titleBackground]}>
           ...
           {invoice.map((intern: any, index : any) => <View style={styles.tableRow}>
              ...
              <View style={[styles.tableCell_9, styles.titleNoBackground]}>
               ...
               <View style={[styles.tableCell_9, styles.titleNoBackground]}>
                <Text style={styles.subtitle3}>{intern?.pushup || ""}</Text>
                {intern?.pushup && <Text style={styles.subtitle3}>(回)</Text>}
              </View>
              {/* <View style={[styles.tableCell_9, styles.titleNoBackground]}>
